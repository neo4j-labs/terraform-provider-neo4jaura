...
func (n *Neo4jAuraProvider) Schema(ctx context.Context, request provider.SchemaRequest, response *provider.SchemaResponse) {
	response.Schema = schema.Schema{
		MarkdownDescription: "Neo4j Aura Terraform Provider.",
		Description:         "Neo4j Aura Terraform Provider.",
...
func (n *Neo4jAuraProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		auradatasource.NewOrganizationUsersDataSource,
		auradatasource.NewOrganizationInvitesDataSource,
	}
}
...
func (n *Neo4jAuraProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		auraresource.NewOrganizationInviteResource,
	}
}
