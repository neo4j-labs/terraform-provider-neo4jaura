...
For databases with valuable data, set `prevent_destroy` so a plan that would replace or destroy the instance fails until you intentionally change this lifecycle rule:
